...
There are two types of {\defin{frames}} implemented as the types
{\type{frame}} (for {\defin{local frames}}) and {\type{rframe}} (for
{\defin{remote frames}}.
In both cases the intention is to store information about
how to represent a compact tree. In particular, where to include
${\constr{CHash}}$ and ${\constr{CAbbrev}}$ nodes.
