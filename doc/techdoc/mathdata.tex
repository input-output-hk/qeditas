...
\and
\inferrule*{v+1\vdash \alpha\ptp}{v\vdash \Lambda\alpha\ptp}
\end{mathpar}
\end{center}
...
\begin{center}
\begin{mathpar}
\inferrule*{\Sigma;v;\cdot\vdash s : o}{\Sigma;v\vdash s \prop}
\and
\inferrule*{\Sigma;v+1\vdash s\prop}{\Sigma;v\vdash \tforall s \prop}
\end{mathpar}
\end{center}
...
\and
\inferrule*{\Sigma=(\cO,\cK)\\ (h,s)\in\cK}{\Sigma;v;\Gamma;\Phi\vdash \known{h} : s}
\and
\inferrule*{\Sigma;v;\Gamma;\Phi\vdash \cD : \tforall s\\v\vdash \beta \ptp}{\Sigma;v;\Gamma;\Phi\vdash \cD \beta : \dbsub{0}{\beta}{s}}
\and
\inferrule*{\Sigma;v;\Gamma;\Phi\vdash \cD : \forall_\alpha s\\\Sigma;v;\Gamma;\Phi\vdash t : \alpha}{\Sigma;v;\Gamma;\Phi\vdash \cD t : \dbsub{0}{t}{s}}
\and
\inferrule*{\Sigma;v;\Gamma;\Phi\vdash \cD : s\to t\\\Sigma;v;\Gamma;\Phi\vdash \cE : s}{\Sigma;v;\Gamma;\Phi\vdash \cD \cE : t}
\and
\inferrule*{\Sigma;v+1;\dbtpsh{0}{1}{\Gamma};\dbtpsh{0}{1}{\Phi}\vdash \cD : s}{\Sigma;v;\Gamma;\Phi\vdash \Lambda \cD : \tforall s}
\and
\inferrule*{\Sigma;v;\alpha,\Gamma;\dbsh{0}{1}{\Phi}\vdash \cD : s}{\Sigma;v;\Gamma;\Phi\vdash \lambda_\alpha \cD : \forall_\alpha s}
\and
\inferrule*{\Sigma;v;\Gamma;s,\Phi\vdash \cD : t}{\Sigma;v;\Gamma;\Phi\vdash \lambda_s \cD : s\to t}
\and
\inferrule*{\Sigma;v;\Gamma;\Phi\vdash s : o \\\Sigma;v;\Gamma;\Phi\vdash t : o}{\Sigma;v;\Gamma;\Phi\vdash s\to t : o}
\and
\inferrule*{\Sigma;v;\Gamma;\Phi\vdash \forall_\alpha \cD : s \\ \Sigma\vdash s \conv t}{\Sigma;v;\Gamma;\Phi\vdash \forall_\alpha \cD : t}
\end{mathpar}
\end{center}
