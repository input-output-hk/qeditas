...
The function {\func{get\_asset}} takes a hash value (an asset hash) and
...
{\bf{Note:}} The keys to the assets in the database are the asset hash (given by {\func{hashasset}}), not the asset id (given by {\func{assetid}}).
