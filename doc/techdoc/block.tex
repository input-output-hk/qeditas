...
The module {\module{DbBlockHeader}} is a database for block headers,
the module {\module{DbBlockDelta}} is a database for block deltas,
and the module
{\module{DbBlockDeltaH}} is a database for block deltas that only store the
transaction ids instead of the full signed transactions.
At the moment, all of these use the basic file storage implementation {\module{Dbbasic}}.
